 ...
 */
function startRAF(element, {
  scrollableArea,
  viewportTolerance,
  viewportSpy = false
}, enterCallback, exitCallback, addRAF,
...
removeRAF // bound function from service to remove elementId to raf pool
  ...
  if (boundingClientRect) {
    ...
    triggerDidEnterViewport(element, isInViewport(boundingClientRect, height, width, viewportTolerance), viewportSpy, enterCallback, exitCallback, viewportEntered);
...
function triggerDidEnterViewport(element, hasEnteredViewport, viewportSpy, enterCallback, exitCallback, viewportEntered = false) {
...
export { RAFAdmin as default, startRAF };
//# sourceMappingURL=raf-admin.js.map
