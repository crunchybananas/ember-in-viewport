 ...
 */
class InViewport extends Service {
  constructor() {
    super(...arguments);
  ...
  _startRaf(element, configOptions, enterCallback, exitCallback) {
    ...
    startRAF(element, configOptions, enterCallback, exitCallback, this.addRAF.bind(this, element.id), this.removeRAF.bind(this, element.id));
  }
}
